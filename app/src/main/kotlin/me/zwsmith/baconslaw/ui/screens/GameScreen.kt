  ...
  Column(
    ...
    when (val state = gameState) {
      ...
      is GameState.InProgress -> {
        ...
        val searchPlaceholder = when (state.moves.lastOrNull()) {
          null, is Move.Movie -> "Search actors…"
          is Move.Actor -> "Search movies…"
        }
        ...
        LaunchedEffect(state.currentPlayer) {
          try {
            ...
            // field not yet attached to the composition tree
          }
        }
